...
train_transforms = transforms.Compose([
    ...
    AdjustBrightness(0.6),  # 1.4 for bright, 0.6 for dark
    # AdjustContrast(0.5),  # 1.6 for high contrast, 0.5 for low contrast
...
!cp models/model.pt drive/MyDrive/models/2020-12-06_ensemble/model2_dark.pt
