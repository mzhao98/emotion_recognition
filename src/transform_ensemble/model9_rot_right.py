...
class Rotate(object):
    def __init__(self, angle):
        self.angle = angle
    def __call__(self, input):
        return transforms.functional.rotate(input, self.angle)
...
from google.colab import drive
drive.mount('/content/drive')
!cp models/model.pt drive/MyDrive/models/2020-12-06_ensemble/model9_rot_right.pt
